...
public class sample extends javax.swing.JInternalFrame {
  ...
  public void displayData(){
       try{
           ...
           ResultSet rs = dbc.getData("SELECT* FROM tbl_subjects");
...
class CustomColumnRenderer extends DefaultTableCellRenderer {
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        ...
        if (rowIndex < 0){
            ...
            if (option == JOptionPane.YES_OPTION) {
                ...
                dbc.deleteData(ids, "tbl_subjects");
                displayData();
            }
        }
    ...
    if (rowIndex < 0) {
        ...
        if (a == JOptionPane.YES_OPTION) {
            ...
            dbc.deleteData(c_id, "tbl_subjects");
            displayData();
        }
    }
    ...
    // Perform the search
    dbConnector dbc = new dbConnector();
    ResultSet resultSet = dbc.searchData("tbl_subjects", searchTerm);
