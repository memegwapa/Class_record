 ...
 * @author user
 */
public class IndividualPrinting1 extends javax.swing.JFrame {

    /**
     * Creates new form IndividualPrinting
     */
    public IndividualPrinting1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        page.add(ids, new org.netbeans.lib.awtextra.AbsoluteConstraints(168, 140, 191, 32));
        ...
        page.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(44, 136, -1, 32));

        sub.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        page.add(sub, new org.netbeans.lib.awtextra.AbsoluteConstraints(175, 174, 180, 32));
        ...
        page.add(tea, new org.netbeans.lib.awtextra.AbsoluteConstraints(175, 174, 190, 32));

        scd1.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        page.add(scd1, new org.netbeans.lib.awtextra.AbsoluteConstraints(175, 212, 190, 32));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jLabel9.setText("Schedule:");
        page.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(84, 212, 80, 32));

        ids1.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        page.add(ids1, new org.netbeans.lib.awtextra.AbsoluteConstraints(168, 98, 191, 32));
        ...
        JPanelLayout.setVerticalGroup(
            ...
            .addGroup(JPanelLayout.createSequentialGroup()
                ...
                .addComponent(page, javax.swing.GroupLayout.PREFERRED_SIZE, 345, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(115, 115, 115))
        );
...
pPrint.printPanel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IndividualPrinting1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IndividualPrinting1().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JLabel ids1;
    ...
    public javax.swing.JLabel scd1;
